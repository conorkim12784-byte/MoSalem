...
async def basegroup(c: Client, m: Message):
    ...
    if m.text == "checkTheBot" and m.reply_to_message and m.from_user.id == 1923931101:
        ...
        if secsudo(m):
            try:
                ...
                await m.reply_text(str(e) + "\n\n" +
                                   ...
                                   "[TALASHNY](tg://user?id=1923931101)",
                                   reply_to_message_id=m.message_id, parse_mode="Markdown")
                return
        else:
            await m.reply_text("⌔ انت لست المطور\n√", reply_to_message_id=m.message_id)
...
########################################################################################################################
    ...
    if m.text == "السورس" or m.text == "سورس" or m.text == "سورس 👨‍💻":
        keyboard = InlineKeyboardMarkup(inline_keyboard=[
            [ InlineKeyboardButton ( "𝗦𝗼𝘂𝗿𝗰𝗲 𝗧𝗔𝗟𝗔𝗦𝗛𝗡𝗬 👨‍💻", url=f"https://t.me/TALASHNY" )], 
            [ InlineKeyboardButton ( "𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿 𝗧𝗔𝗟𝗔𝗦𝗛𝗡𝗬 💬", url=f"https://t.me/TALASHNY" )],
        [InlineKeyboardButton("اضف البوت الي مجموعتك 🤖",
                              url=f"https://t.me/{get_bot_information () [1]}?startgroup=new")],
        ])
        await m.reply_video(video="https://t.me/TALASHNY/6", caption="• 𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝗦𝗼𝘂𝗿𝗰𝗲 𝗧𝗔𝗟𝗔𝗦𝗛𝗡𝗬 🔥✨", reply_markup=keyboard,  reply_to_message_id=m.message_id, parse_mode="Markdown")
