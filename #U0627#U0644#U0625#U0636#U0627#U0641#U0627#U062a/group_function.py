...
########################################################################################################################
    ...
    if m.text == "السورس" or m.text == "سورس" or m.text == "سورس 👨‍💻":
        keyboard = InlineKeyboardMarkup(inline_keyboard=[
            [ InlineKeyboardButton ( "𝗦𝗼𝗨𝗿𝗖𝗲 𝗕𝗲𝗧𝗮 👨‍💻", url=f"https://t.me/TALASHNY" )], 
            [ InlineKeyboardButton ( "𝗗𝗲𝗩𝗲𝗟𝗼𝗣𝗲𝗥 𝗕𝗲𝗧𝗮 💬", url=f"https://t.me/TALASHNY" )],
        [InlineKeyboardButton("اضف البوت الي مجموعتك 🤖",
                              url=f"https://t.me/{get_bot_information () [1]}?startgroup=new")],
        ])
        await m.reply_video(video="https://t.me/TALASHNY/6", caption="• 𝗪𝗲𝗹𝗖𝗼𝗠𝗲 𝗦𝗼𝗨𝗿𝗖𝗲 𝗕𝗲𝗧𝗮 🔥✨", reply_markup=keyboard,  reply_to_message_id=m.message_id, parse_mode="Markdown")
